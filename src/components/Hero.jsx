      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className='text-[#915EFF]'>Nilay</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
          "I am a passionate Software Engineer, <br className='sm:block hidden' />
          actively seeking SRE, cloud engineering and DevOps roles to enhance my skills and contribute to innovative projects." </p>
          {/* Add icons and button here */}
          <div className="flex flex-col items-center mt-8 space-y-6">
            <div className="flex space-x-12">
              <a 
                href="https://github.com/Nilay-hub" 
                target="_blank" 
              ...
              <a 
                href="https://www.linkedin.com/in/nilay-patel-958b401a1" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center justify-center"
              >
